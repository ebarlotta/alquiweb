                    ...
                    <div class="card bg-gradient-primary mr-2" style="width: 95%">
                        ...
                        <div class="card-body">
                            <div id="world-map"
                                ...
                                <svg width="500.833" height="250">
                                    <g transform="scale(0.42158516020236086) translate(114.48793800000007, 0)">
                                        <path
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="picker-switch" data-action="pickerSwitch"
                                                                    colspan="5" title="Select Month">September 2024
                                                                </th>
                                ...
                                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="custom-tabs-one-messages-tab" data-toggle="pill"
                                            ...
                                            aria-controls="custom-tabs-one-messages" aria-selected="false">Historial
                                            del
                                            Inmueble</a>
                                    </li>
                                </ul>
                                        ...
                                        <div class="col-12 d-flex">
                                            <div class="col-10">
                                                <div class="col-12 d-flex">
                                                    ...
                                                    <div class="d-flex flex-wrap col-8 m-2 p-2 rounded-md justify-content-center"
                                                        style="background-color: lightgray;border-radius: 5px;">
                                                        <div class="input-group col-xl-6">
                                                            <button type="button"
                                                                class="col-3 btn btn-info form-control">Tipo</button>
                                                            <input type="text" class="col-9 form-control">
                                                        </div>
                                                        <div class="input-group col-xl-6">
                                                            <button type="button"
                                                                class="col-3 btn btn-info form-control">Código</button>
                                                            <input type="text" class="col-9 form-control">
                                                        </div>
                                                        <div class="input-group col-12">
                                                            <button type="button"
                                                                class="col-3 btn btn-info form-control">Calle</button>
                                                            <input type="text" class="col-9 form-control">
                                                        </div>
                                                        <div class="input-group col-xl-6">
                                                            <button type="button"
                                                                class="col-3 btn btn-info form-control">Altura</button>
                                                            <input type="text" class="col-9 form-control">
                                                        </div>
                                                        <div class="input-group col-xl-6">
                                                            <button type="button"
                                                                class="col-3 btn btn-info form-control">Depto</button>
                                                            <input type="text" class="col-9 form-control">
                                                        </div>
                                                        <div class="input-group px-2">
                                                            <button type="button"
                                                                class="col-3 btn btn-info form-control">Provincia</button>
                                                            <input type="text" class="col-9 form-control">
                                                        </div>
                                                        <div class="input-group px-2">
                                                            <button type="button"
                                                                class="col-3 btn btn-info form-control">Localidad</button>
                                                            <input type="text" class="col-9 form-control">
                                                        </div>
                                                        <input type="button"
                                                            class="form-control btn-success mx-3 col-4"
                                                            value="Guardar">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                        ...
                                        <div class="col-12 d-flex">
                                            ...
                                            <div class="col-9 d-flex flex-wrap m-2 p-2 rounded-md"
                                                ...
                                                <div class="input-group mb-3 col-6">
                                                    <div class="input-group-prepend">
                                                        <button type="button"
                                                            class="btn btn-info">Apellidos</button>
                                                    </div>
                                                    <input type="text" class="form-control">
                                                </div>
                                                <div class="input-group mb-3 col-6">
                                                    <div class="input-group-prepend">
                                                        <button type="button"
                                                            class="btn btn-info">Nombre(s)</button>
                                                    </div>
                                                    <input type="text" class="form-control">
                                                </div>
                                                <div class="input-group mb-3 col-6">
                                                ...
                                                <div class="input-group mb-3 col-6">
                                                    <div class="input-group-prepend">
                                                        <button type="button"
                                                            class="btn btn-info">Teléfonos</button>
                                                    </div>
                                                    <input type="text" class="form-control">
                                                </div>
                                                <div class="input-group mb-3 col-6">
                                                    <div class="input-group-prepend">
                                                        <button type="button"
                                                            class="btn btn-info">Whatsapp</button>
                                                    </div>
                                                    <input type="text" class="form-control">
                                                </div>
                                                <div class="input-group mb-3 col-6">
                                                ...
                                                <div class="input-group mb-3 col-6">
                                                    <div class="input-group-prepend">
                                                        <button type="button" class="btn btn-info">Fecha
                                                            Nacimiento</button>
                                                    </div>
                                                    <input type="text" class="form-control">
                                                </div>
                                                <div class="input-group mb-3 col-xl-6">
                                                    <div class="input-group-prepend">
                                                        <button type="button"
                                                            class="btn btn-info">Domicilio</button>
                                                    </div>
                                                    <input type="text" class="form-control">
                                                </div>
                                                <div class="input-group mb-3 col-6">
                                                    <div class="input-group-prepend">
                                                        <button type="button"
                                                            class="btn btn-info">Provincia</button>
                                                    </div>
                                                    <input type="text" class="form-control">
                                                </div>
                                                <div class="input-group mb-3 col-6">
                                                    <div class="input-group-prepend">
                                                        <button type="button"
                                                            class="btn btn-info">Localidad</button>
                                                    </div>
                                                    <input type="text" class="form-control">
                                                </div>
                                                <div class="input-group mb-3 col-xl-6">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                ...
                                                <div class="card text-white mb-3"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="input-group mb-3 col-xl-6">
                                                            <div class="input-group-prepend">
                                                                <button type="button" class="btn btn-info">F.de
                                                                    Pago
                                                                    Inq.</button>
                                                            </div>
                                                            <input type="text" class="form-control">
                                                ...
                                                <div class="card text-white mb-3"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="input-group mb-3 col-xl-6">
                                                            <div class="input-group-prepend">
                                                                <button type="button"
                                                                    class="btn btn-info">Actualización</button>
                                                            </div>
                                                            <input type="text" class="form-control">
                                                        </div>
                                                        <div class="input-group mb-3 col-xl-6">
